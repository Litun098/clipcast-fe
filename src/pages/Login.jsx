  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "/api/v1/users/login",
        {
          ...formData, // Sending identifier (email or username) and password
        },
      ...
      setError(message);
      console.error("Error response:", message || err);
    }
  };
          ...
          <div className="mt-20 flex w-full flex-col items-start justify-start p-6 md:w-1/2 lg:px-10">
            <div className="w-full">
              ...
              <p className="text-xs text-slate-400">
                Please log in using your email or username and password
              </p>
            </div>
            <form
